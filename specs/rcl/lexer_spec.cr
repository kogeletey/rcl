...
describe XrayRCL::Lexer do
  describe "#next_token - strings" do
    it "tokenizes simple string" do
      lexer = XrayRCL::Lexer.new("\"hello\"")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::String)
      token.value.should eq("hello")
    end

    it "tokenizes string with spaces" do
      lexer = XrayRCL::Lexer.new("\"hello world\"")
      token = lexer.next_token
  ...
  describe "#next_token - numbers" do
    it "tokenizes small number" do
      lexer = XrayRCL::Lexer.new("123")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Number)
      token.value.should eq("123")
    end

    it "tokenizes large number" do
      lexer = XrayRCL::Lexer.new("12598959")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Number)
    ...
    it "tokenizes very large number" do
      lexer = XrayRCL::Lexer.new("987654321")
      token = lexer.next_token
  ...
  describe "#next_token - identifiers" do
    it "tokenizes simple identifier" do
      lexer = XrayRCL::Lexer.new("server_port")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Identifier)
      token.value.should eq("server_port")
    end

    it "tokenizes identifier with numbers" do
      lexer = XrayRCL::Lexer.new("port123")
      token = lexer.next_token
  ...
  describe "#next_token - keywords" do
    it "tokenizes do keyword" do
      lexer = XrayRCL::Lexer.new("do")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Do)
    end

    it "tokenizes end keyword" do
      lexer = XrayRCL::Lexer.new("end")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::End)
    end

    it "tokenizes true as identifier" do
      lexer = XrayRCL::Lexer.new("true")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Identifier)
  ...
  describe "#next_token - operators and delimiters" do
    it "tokenizes equal sign" do
      lexer = XrayRCL::Lexer.new("=")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Equal)
    end

    it "tokenizes comma" do
      lexer = XrayRCL::Lexer.new(",")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Comma)
    end

    it "tokenizes opening bracket" do
      lexer = XrayRCL::Lexer.new("[")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::LBracket)
    end

    it "tokenizes closing bracket" do
      lexer = XrayRCL::Lexer.new("]")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::RBracket)
    end
  end

  describe "#next_token - comments" do
    it "skips hash comments" do
      lexer = XrayRCL::Lexer.new("# comment\nvalue")
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::Identifier)
    ...
    it "skips inline hash comments" do
      lexer = XrayRCL::Lexer.new("value # comment")
      token = lexer.next_token
      token.value.should eq("value")
    end
  end
  ...
  describe "#next_token - EOF" do
    it "returns EOF token at end" do
      ...
      lexer.next_token
      token = lexer.next_token
      token.type.should eq(XrayRCL::TokenType::EOF)
    end
  end
end
